...
function dummySuccessMail(email, transaction_id, exchange_logo_path, exchange_logo_file_name , tx_hash, tx_hash_link, sell_coin, get_coin, sell_coin_name, get_coin_name, transaction_type, sell_amount, get_amount, sell_coin_logo, get_coin_logo, completion_time, deposit_address, recipient_address){
    const mailOptions = {
        from: process.env.EMAIL,
        to: email,
        subject: 'Swap Status',
...
app.get('/test/mail',(req, res)=>{
    dummySuccessMail("softwareengineermoeed@gmail.com", "gskfxkirtnjntia1", "./views/images/Changelly Offer.png", "Changelly Offer.png", "32dcfd286cdbcc48d0fc10be5ff64756a2dd7d7919440fe30774b63a529a84e0", "https://tronscan.org/#/transaction/32dcfd286cdbcc48d0fc10be5ff64756a2dd7d7919440fe30774b63a529a84e0", "BTC", "ETH", "BITCOIN", "ETHEREUM", "Floating", "0.1", "4.28765324", "https://content-api.changenow.io/uploads/eth_f4ebb54ec0.svg", "https://content-api.changenow.io/uploads/btc_1_527dc9ec3c.svg", "2024-09-11 23:34:10", "0xb3c93d6f06ef0aa4d080c4b73103a1c3513067a3", "1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa" )
